...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> createBooking(Long userId, BookingDtoRequest requestDto) {
    ...
    public ResponseEntity<Object> approveBooking(Long ownerId, Long id, Boolean isApproved) {
        Map<String, Object> parameters = Map.of("isApproved", isApproved);
        return patch("/" + id + "?isApproved={isApproved}", ownerId, parameters, null);
    }
